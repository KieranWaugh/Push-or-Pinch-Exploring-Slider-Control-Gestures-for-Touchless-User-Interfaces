...
class Frame{
    ...
    Frame(Main.FrameCategory activity, Main.State state, String message, float cursor_X, float cursor_y, float slider_position_X, String slider_value){
    ...
    Frame(Main.FrameCategory activity, Main.State state, float cursor_X, float cursor_y, float slider_position_X, String slider_value){
        this.activity = activity;
        this.state = state;
        this.cursor_X = cursor_X;
        this.cursor_y = cursor_y;
